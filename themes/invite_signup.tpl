...
{if $enable_fc eq "1"}
<p class="auth_text" style="margin-top: 100px; font-size:24px">{$lang59}</p>
...
<form id="sysForm" method="POST" class="Form FancyForm AuthForm" action="{$baseurl}/invite_signup?c={$c}">
    <ul>
        <li>
