                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="example" name="example" value="{$category.example|stripslashes}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Preview </label></td>
                                                        <td class="value">
                                                            <img src="{$imageurl}/cat/{$category.CATID}{$category.ext}?{$smarty.now}">
                                                        </td>
