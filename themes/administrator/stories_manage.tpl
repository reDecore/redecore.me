                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Manage Pins</h4>
							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" ">{$results[i].ptitle|stripslashes|truncate:300:"...":true}{if $results[i].youtube ne ""} <b>[VIDEO]</b>{/if}<br /><img src="{$purl}/t/s-{$results[i].pic}" /></td>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Pins - Manage Pins</h3>
                            </div>
